...
//		Member member = new Member("1150513","Test","123456","台北市","0900");
//		new MemberDaoImpl().addMember(member);
		
//		System.out.println(new MemberDaoImpl().login("stage", "0124"));
		
		System.out.println(new MemberDaoImpl().checkUsername("alex"));
